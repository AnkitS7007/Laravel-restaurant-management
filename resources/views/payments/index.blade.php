                                            ...
                                            @foreach ($table->sales as $sale)
                                                @if ($sale->created_at >= Carbon\Carbon::today())
                                                    <div style="border: dashed pink" class="mb-2 mt-2 shadow w-100" id="{{ $sale->id }}">
                                                        <div class="card">
                                                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                                                ...
                                                                <h5 class="font-weight-bold mt-2">
                                                                    <span class="badge badge-light">
                                                                        Pending: {{ $sale->change }} DH
                                                                    </span>
                                                                </h5>
                                                                <h5 class="font-weight-bold mt-2">
                                                                    <span class="badge badge-light">
                                                                        Mode of payment:
                                                                        {{ $sale->payment_type === "cash" ? "Cash" : "Bank card" }}
                                                                    </span>
                                                                </h5>
                                                                <h5 class="font-weight-bold mt-2">
                                                                    <span class="badge badge-light">
                                                    ...
                                                    <div class="mt-2 d-flex justify-content-center">
                                                        ...
                                                        <a href="#" target="_blank" class="btn btn-sm btn-primary" onclick="print({{ $sale->id }})">
                ...
                <div class="col-md-12 card p-3">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        @foreach ($categories as $category)
                            <li class="nav-item">
                                <a href="#{{ $category->slug }}" class="nav-link mr-1 {{ $category->slug === "salades-marocaines" ? "active" : "" }}" id="{{ $category->slug }}-tab" data-toggle="pill" role="tab" aria-controls="{{ $category->slug }}" aria-selected="true">
                                    {{ $category->title }}
                                </a>
                            </li>
                        @endforeach
                    ...
                    <div class="tab-content" id="pills-tabcontent">
                        @foreach ($categories as $category)
                            <div class="tab-pane fade {{ $category->slug === "salades-marocaines" ? "show active" : "" }}" id="{{ $category->slug }}" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="change" class="form-control" placeholder="Pending">
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                        .00
                                    </div>
